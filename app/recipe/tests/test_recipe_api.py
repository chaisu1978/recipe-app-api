...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_full_update(self):
        ...
        payload = {
            ...
            'link': 'https://example.com/rew-recipe.pdf',
    ...
    def test_update_user_returns_error(self):
        """Test changing the recipe user recipe user results in an error."""
    ...
    def test_create_recipe_with_new_ingredients(self):
        ...
        payload = {
            'title': 'Cauliflour Tacos',
            'time_minutes': 60,
            'price': Decimal('4.30'),
            'ingredients': [{'name': 'Cauliflour'}, {'name': 'Salt'}]
        }
        res = self.client.post(RECIPIES_URL, payload, format='json')
        self.assertEqual(res.status_code, status.HTTP_201_CREATED)
        recipes = Recipe.objects.filter(user=self.user)
    ...
    def test_filter_by_ingredients(self):
        ...
        r2 = create_recipe(user=self.user, title='Chicken Cocciatore')
